    ...
    return (
        <section className="section section-footer">
            <div className="footer">
                <div className="footer-sec footer-sec1">
                ...
                <div className="footer-sec footer-sec2">
                    <h4 className="footer-sec-heading">Social Links</h4>
                    <div className="footer-sec-links ">
                        <NavLink className="social-links" to={"/"}>
                ...
                <div className="footer-sec footer-sec3">
                    <h4 className="footer-sec-heading">Contact Us</h4>
                    <div className="footer-sec-links">
                ...
                <div className="footer-sec footer-sec4">
                    <h4 className="footer-sec-heading">Registered Office</h4>
                    <div className="footer-sec-links">
