...
function Footer(props) {
    return (
        <section className="upg-pag-section upg-pag-section-footer">
            <div className="upg-pag-footer">
                <div className="upg-pag-footer-sec upg-pag-footer-sec1">
                    <h4 className="upg-pag-footer-sec-heading">Other Links</h4>
                    <div className="upg-pag-footer-sec-links">
                ...
                <div className="upg-pag-footer-sec upg-pag-footer-sec2">
                    <h4 className="upg-pag-footer-sec-heading">Social Links</h4>
                    <div className="upg-pag-footer-sec-links">
                        <NavLink upg-pag-className="social-links" to={"/"}>
                        ...
                        <NavLink className="upg-pag-social-links" to={"/"}>
                ...
                <div className="upg-pag-footer-sec upg-pag-footer-sec3">
                    <h4 className="upg-pag-footer-sec-heading">Contact Us</h4>
                    <div className="upg-pag-footer-sec-links">
                        <p className="upg-pag-footer-email">
                            support@tutedude.com
                        </p>
                        <p className="upg-pag-footer-phone">
                            +91 7988800474
                        </p>
                    </div>
                </div>
                <div className="upg-pag-footer-sec upg-pag-footer-sec4">
                    <h4 className="upg-pag-footer-sec-heading">Registered Office</h4>
                    <div className="upg-pag-footer-sec-links">
                        <div className="upg-pag-footer-address">
