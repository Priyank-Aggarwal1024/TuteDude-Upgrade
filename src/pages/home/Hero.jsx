...
function Hero(props) {
    return (
        <section className="upg-pag-section upg-pag-hero-section">
            <svg className="upg-pag-hero-design" xmlns="http://www.w3.org/2000/svg" width="571" height="738" viewBox="0 0 571 738" fill="none">
                <g opacity="0.4">
            ...
            <div className="upg-pag-hero-top">
                <div className="upg-pag-ht-left">
                    <h1 className="upg-pag-hero-heading upg-pag-fw-400 upg-pag-f-55 upg-pag-text-black">Make the smarter you more smarter by <span className="upg-pag-text-pink upg-pag-fw-700">adding any 3 course at just ₹ 799</span></h1>
                    <p className="upg-pag- upg-pag-fw-500 upg-pag-text-black upg-pag-hero-top-para">Purchase any 3 course and increase REFUND validity to1 Year</p>
                    <div className="upg-pag-htl-bottom">
                        <div className="upg-pag-htl-bottom-left">
                            <div ><span className="upg-pag-f-34 upg-pag-fw-700 upg-pag-text-black">₹ 799 </span>{" "}<span className="upg-pag-fw-400 upg-pag-td-lt upg-pag-price-cut" style={{ color: "#585858" }}>₹2197</span><p className="upg-pag-f-16 upg-pag-fw-700" style={{
                                color: "#04BD00"

                            }}>Flat 40% OFF</p></div>
                            <p className="upg-pag-enroll-now">Enroll Now</p>
                        </div>
                    </div>
                </div>
                <div className="upg-pag-ht-right">
                    <img src={HeroImg} alt="Hero Image" />
                </div>
            </div>
            {/* <div className="upg-pag-hero-middle">
                <div className="upg-pag-hm-left">
                    <p className="upg-pag-fw-700 upg-pag-f-34 upg-pag-text-pink upg-pag-text-center">3</p>
                    <p className="upg-pag-fw-700 upg-pag-f-16 upg-pag-text-pink" style={{ color: "#263238" }}>Selected Course</p>
                </div>
                <div className="upg-pag-hm-middle">
                    <p className="upg-pag-fw-700 upg-pag-f-34 upg-pag-text-pink upg-pag-text-center">₹799</p>
                    <p className="upg-pag-fw-700 upg-pag-f-16 upg-pag-text-pink" style={{ color: "#263238" }}>Total Price </p>
                </div>
                <div className="upg-pag-hm-right">
                    <div className="upg-pag-proceed upg-pag-f-18 upg-pag-text-white">Procced</div>
                </div>
            </div> */}
            ...
            <div className="upg-pag-hero-bottom">
                <div className="upg-pag-hb-card upg-pag-hb-card-1">
                    <div className="upg-pag-hb-card-inner1">
                        <p className="upg-pag-hero-card1-heading">Special Offer for you</p>
                        <div className="upg-pag-hero-card-inner">
                            <p className="upg-pag-hero-card1-para" >
                                ...
                                <span className="upg-pag-f-24 upg-pag-fw-400">Purchase any 3 course:  </span>
                                <span className="upg-pag-f-24 upg-pag-fw-700">{" "}₹799</span>
                            </p>
                            <p className="upg-pag-hero-card1-para" >
                                ...
                                <span className="upg-pag-f-24 upg-pag-fw-400">100% Refund Validity :</span>
                                <span className="upg-pag-f-24 upg-pag-fw-700">{" "} 1 Year</span>
                            </p>
                        </div>
                        <p className="upg-pag-select-course-btn">Select Course</p>
                    </div>
                </div>
                <div className="upg-pag-hb-card upg-pag-hb-card-2">
                    <div className="upg-pag-hb-card-inner2">
                        <p className="upg-pag-hero-card2-heading">Your previous Purchase</p>
                        <div className="upg-pag-hero-card-inner">
                            <p className="upg-pag-hero-card2-para" >
                                ...
                                <span className="upg-pag-f-24 upg-pag-fw-400">Purchased One course:</span>
                                <span className="upg-pag-f-24 upg-pag-fw-700">{" "}₹799</span>
                            </p>
                            <p className="upg-pag-hero-card2-para" >
                                ...
                                <span className="upg-pag-f-24 upg-pag-fw-400">100% Refund Validity : </span>
                                <span className="upg-pag-f-24 upg-pag-fw-700">{" "}3Month</span>
                            </p>
                        </div>
                    </div>
                </div>
